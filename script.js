...
// ===== CINEMATIC MOCKUP SCROLL SEQUENCE =====
// The hero-scene is 300vh tall.
// .hero is pinned by GSAP ScrollTrigger (not CSS sticky) while we scroll through the scene.
// This is ONE continuous motion (no static hold in the middle):
// 0 → 0.5: mockup travels to center while growing to its peak scale
// 0.5 → 1: mockup keeps moving, shrinks back down, exits left, fades out
